...
###############################################
#Calculate geodist for each line
###############################################
...
#save project:
###########################
save.image(file = "07a.GeneticRandomForestIterative.2019-06-18.RData")
...
pdf("Straight_scatter1.pdf", 5, 5)
plot(StraightMeanDF.train$genetdist, Straight_RF2$predicted)
dev.off()

pdf("Straight_scatter_test.pdf", 5, 5)
plot(StraightMeanDF.train$genetdist, predict(Straight_RF2, StraightMeanDF.train))
dev.off()

pdf("Straight_scatter2.pdf", 5, 5)
plot(StraightMeanDF.valid$genetdist, predict(Straight_RF2, StraightMeanDF.valid))
dev.off()

StraightPred2 <- predict(env, Straight_RF2)
