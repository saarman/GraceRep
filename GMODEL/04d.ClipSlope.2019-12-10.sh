...
##SBATCH -n 1 -c 1  -N 1  
##SBATCH -t 24:00:00
#SBATCH --output=04d.ClipSlope.2019-12-10.sh.log
#SBATCH --job-name=04d.ClipSlope.2019-12-10.sh
##DATA SOURCE: https://github.com/evlynpless/MOSQLAND/tree/master/MERIT/slope
##COMMAND: sbatch /gpfs/loomis/home.grace/fas/caccone/nps25/scripts/GraceRep/GMODEL/04d.ClipSlope.2019-12-10.sh
##LOG FILE: cat /gpfs/loomis/home.grace/fas/caccone/nps25/scripts/GraceRep/GMODEL/04d.ClipSlope.2019-12-10.sh.log
