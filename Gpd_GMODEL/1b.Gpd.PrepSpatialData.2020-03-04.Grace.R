###############################################
#R Script: Note that this is also tested locally as "~/Dropbox/Caccone_Aksoy/Glossina-spatial/Gpd-RF-Genetic-Model/1b.Gpd.PrepSpatialData.2020-03-04.Rmd"
###############################################
...
save.image(file="1b.Gpd.PrepSpatialData.2020-03-04.Grace.RData")
